...
const DEMAND_DATA = [
    ...
    // GLASGOW
    { lng: -4.2518, lat: 55.8642, occupancy: 81, area: 'City Centre, G1', source: 'airbnb' },
    { lng: -4.2778, lat: 55.8698, occupancy: 75, area: 'West End, G12', source: 'airbnb' },
    { lng: -4.2434, lat: 55.8567, occupancy: 72, area: 'Merchant City, G1', source: 'airbnb' },
    { lng: -4.2765, lat: 55.8572, occupancy: 68, area: 'Finnieston, G3', source: 'airbnb' },
    { lng: -4.2200, lat: 55.8430, occupancy: 61, area: 'Southside, G41', source: 'airbnb' },
    { lng: -4.2520, lat: 55.8670, occupancy: 78, area: 'City Centre VRBO', source: 'vrbo' },

    // EDINBURGH (extra districts)
    { lng: -3.1720, lat: 55.9742, occupancy: 83, area: 'Leith, EH6', source: 'airbnb' },
    { lng: -3.2040, lat: 55.9575, occupancy: 79, area: 'Stockbridge, EH4', source: 'airbnb' },
    { lng: -3.1920, lat: 55.9410, occupancy: 76, area: 'Meadows, EH9', source: 'airbnb' },

    // ABERDEEN
    { lng: -2.0943, lat: 57.1497, occupancy: 65, area: 'City Centre, AB10', source: 'airbnb' },
    { lng: -2.0800, lat: 57.1600, occupancy: 58, area: 'Old Aberdeen, AB24', source: 'airbnb' },

    // DUNDEE
    { lng: -2.9707, lat: 56.4620, occupancy: 60, area: 'City Centre, DD1', source: 'airbnb' },
    { lng: -2.9880, lat: 56.4680, occupancy: 55, area: 'West End, DD2', source: 'airbnb' },

    // LIVERPOOL
    { lng: -2.9916, lat: 53.4084, occupancy: 78, area: 'City Centre, L1', source: 'airbnb' },
    { lng: -2.9800, lat: 53.3980, occupancy: 73, area: 'Baltic Triangle, L1', source: 'airbnb' },
    { lng: -2.9720, lat: 53.4060, occupancy: 70, area: 'Ropewalks, L1', source: 'airbnb' },
    { lng: -2.9950, lat: 53.4100, occupancy: 76, area: 'City Centre VRBO', source: 'vrbo' },

    // SHEFFIELD
    { lng: -1.4701, lat: 53.3811, occupancy: 68, area: 'City Centre, S1', source: 'airbnb' },
    { lng: -1.4800, lat: 53.3860, occupancy: 63, area: 'Kelham Island, S3', source: 'airbnb' },
    { lng: -1.5050, lat: 53.3750, occupancy: 59, area: 'Ecclesall Road, S11', source: 'airbnb' },

    // NOTTINGHAM
    { lng: -1.1581, lat: 52.9548, occupancy: 70, area: 'City Centre, NG1', source: 'airbnb' },
    { lng: -1.1460, lat: 52.9520, occupancy: 64, area: 'Lace Market, NG1', source: 'airbnb' },
    { lng: -1.1700, lat: 52.9480, occupancy: 61, area: 'Hockley, NG1', source: 'airbnb' },

    // NEWCASTLE
    { lng: -1.6178, lat: 54.9783, occupancy: 72, area: 'City Centre, NE1', source: 'airbnb' },
    { lng: -1.6020, lat: 54.9850, occupancy: 65, area: 'Jesmond, NE2', source: 'airbnb' },
    { lng: -1.6100, lat: 54.9800, occupancy: 62, area: 'Sandyford, NE2', source: 'airbnb' },

    // CARDIFF
    { lng: -3.1791, lat: 51.4816, occupancy: 74, area: 'City Centre, CF10', source: 'airbnb' },
    { lng: -3.1580, lat: 51.4870, occupancy: 66, area: 'Roath, CF24', source: 'airbnb' },
    { lng: -3.1800, lat: 51.4950, occupancy: 62, area: 'Cathays, CF24', source: 'airbnb' },
    { lng: -3.1810, lat: 51.4820, occupancy: 71, area: 'City Centre VRBO', source: 'vrbo' },

    // BELFAST
    { lng: -5.9301, lat: 54.5973, occupancy: 74, area: 'City Centre, BT1', source: 'airbnb' },
    { lng: -5.9240, lat: 54.6020, occupancy: 69, area: 'Cathedral Quarter, BT1', source: 'airbnb' },
    { lng: -5.9350, lat: 54.5950, occupancy: 71, area: 'City Centre VRBO', source: 'vrbo' },
];
